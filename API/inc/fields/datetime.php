...
if ( ! class_exists( 'anim8_Datetime_Field' ) )
{
	class anim8_Datetime_Field
	{
		/**
		...
		static function admin_enqueue_scripts( )
		{
			...
			wp_enqueue_script( 'anim8-datetime', API_JS_URL . 'datetime.js', array( 'jquery-ui-timepicker' ), API_VER, true );
		}
